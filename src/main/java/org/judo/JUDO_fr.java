...
public class JUDO_fr extends JUDO_localization {
  public JUDO_fr() {
    ...
    IDE_ERR_INIT_JAVA = "Erreur d'initialisation de Java, consultez le fichier README.txt livré avec JUDO";
    ...
    IDE_EDIT_GOTO_LINE = "Aller à la ligne...";

    IDE_PROG = "Programme";
    IDE_PROG_PROP = "Propriétés du programme...";

    IDE_RUN = "Exécuter";
    IDE_RUN_RUN = "Exécuter";
    IDE_RUN_COMPILE = "Compiler";

    IDE_HELP = "Aide";
    IDE_HELP_JUDO_HELP = "JUDO Aide";
    IDE_HELP_TUTORIALS = "Tutorials";
    IDE_HELP_FUNC_REF = "JUDO Référence des fonctions";
    IDE_HELP_COLOR_REF = "Référence des valeurs de couleurs";
    ...
    IDE_404_ERR = "Erreur: Fichier %s n'a pas été trouvé.";
    IDE_READ_FILE_ERR = "Erreur: Lecture du fichier %s.";
    IDE_CREATE_FILE_ERR = "Erreur: Fichier %s ne peux pas etre créé.";
    ...
    IDE_GOTO_LINE_NUM_MSG = "Aller au numéro de ligne";
    IDE_GOTO_LINE_NUM_TIT = "Aller au numéro de ligne";
    IDE_LINE_NUM_GREATER_MSG = "numéro de ligne doit etre plus grand ou égal à 1";
    IDE_INV_LINE_NUM_TIT = "numéro de ligne pas valable";
    IDE_LINE_COUNT_MSG = "Il y a seulement %s lignes dans le Programme";
    IDE_NO_LINE_NUM_MSG = "Vous n'avez pas donner de numéro de ligne";
    IDE_LINE_NUM_INV_MSG = "numéro de ligne %s n'est pas valable.";

    IDE_VAR_VAL_DEC_ASS_TIT = "Variables, Valeurs, Déclarations, et Assignements";
    IDE_JUDO_ABOUT_MSG = "JUDO - Un IDE java pour les programmeurs débutants\nhttp://judo.sourceforge.net\nVersion: %s\n\nJUDO, Copyright (C) 2001-2003 Thomas J. Dunn";
